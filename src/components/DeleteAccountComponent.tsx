...
> {
			...
			<div>
				...
				>
					<DialogTitle id="form-dialog-title">
						Sei sicuro di eliminare {this.props.data.user.username}?
					</DialogTitle>
					<DialogContent className="central">
						<div className="centralModal">
							...
							<FormLabel className={"role_title"}>
								{this.props.data.user.authorities.length > 1
									? "Ruoli: "
									: "Ruolo: "}
							</FormLabel>
						...
						<FormHelperText id="trashMessage">
							{this.state.error}
						</FormHelperText>
					</DialogContent>
					<DialogActions>
	...
	private handleConfirm(): void {
		if (!this.isUserDeletingHimself()) {
			this.props.dispatch.deleteAccount(this.props.data.user.link, {
