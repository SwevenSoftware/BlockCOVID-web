...
export const PENCIL_CONFIRM = "PENCIL_CONFIRM"
export const PENCIL_CANCEL = "PENCIL_CANCEL"
export const PENCIL_FAILURE = "PENCIL_FAILURE"
export const PENCIL_SUCCESS = "PENCIL_SUCCESS"

export const TRASH_ACCOUNTS_CONFIRM = "TRASH_ACCOUNTS_CONFIRM"
export const TRASH_ACCOUNTS_SUCCESS = "TRASH_ACCOUNTS_SUCCESS"
export const TRASH_ROOMS_CONFIRM = "TRASH_ROOMS_CONFIRM"
export const TRASH_ROOMS_SUCCESS = "TRASH_ROOMS_SUCCESS"
