...
export const pencilTypes = {
    PENCIL_CONFIRM: "PENCIL_CONFIRM",
    PENCIL_CANCEL: "PENCIL_CANCEL",
    PENCIL_FAILURE: "PENCIL_FAILURE",
    PENCIL_SUCCESS: "PENCIL_SUCCESS"
}

export const trashTypes = {
    TRASH_ACCOUNTS_CONFIRM: "TRASH_ACCOUNTS_CONFIRM",
    TRASH_ACCOUNTS_SUCCESS: "TRASH_ACCOUNTS_SUCCESS",
    TRASH_ROOMS_CONFIRM: "TRASH_ROOMS_CONFIRM",
    TRASH_ROOMS_SUCCESS: "TRASH_ROOMS_SUCCESS",
    TRASH_CANCEL: "TRASH_CANCEL",
...
export const newUserTypes = {
    ...
    NEW_USER_CANCEL: "NEW_USER_CANCEL"
}
