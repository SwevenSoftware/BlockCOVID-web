...
describe('Room actions', () => {
    ...
    it('should correctly handle room modification', function() {
        ...
        store.dispatch(roomActionsResolver.modifyRoom({ url: "/api/rooms/", roomName: "roomName", data: roomInformation }))
        // expect(store.getActions()).toContain(expectedAction)
    });
    ...
    it('should correctly handle room deletion', function() {
        ...
        store.dispatch(roomActionsResolver.deleteRoom("api/rooms/", { roomName: "room" }))
        // expect(store.getActions()).toContain(expectedAction)
    });
